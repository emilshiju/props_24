...
const EditDetailedCity = ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  const getInitialValues = (): detailedCityType => ({
    ...
    details: {
      ...
      availableProperties: allData?.availableProperties || "",
      description: allData?.description || "",
    },
    about: {
      content: allData?.aboutContent || "",
    },
    image: allData?.imageUrl || null,
    areas: allData?.areas?.length
      ? allData.areas
      : Array(5).fill({ heading: "", content: "" }),
    types: allData?.types?.length
      ? allData.types
      : Array(4).fill({ heading: "", content: "", price: "" }),
  });

  const initialValues = getInitialValues();

  const fetchDetailedCity = async () => {
    const ress = await detailedViewCityApi(id);
    setData(ress.data);
    setPreview(ress.data.imageUrl);
  };
  ...
  const filteredCityList = allCity.filter(
    (city) => city.id !== allData?.cityId
  );

  console.log("herere gottt");
  console.log(allData?.city?.cityName);
              ...
              {activeSection === "details" && (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    />
                    <div className="h-1">
                      {errors.details?.averagePrice &&
                      touched.details?.averagePrice ? (
                  ...
                  <div>
                    ...
                    />
                    <div className="h-1">
                      {errors.details?.popularity &&
                      touched.details?.popularity ? (
                        <div className="text-red-500 text-xs mt-1 ">
                          {errors.details.popularity}
                        </div>
                      ) : null}
                  ...
                  <div>
                    ...
                    />
                    <div className="h-1">
                      {errors.details?.availableProperties &&
                      touched.details?.availableProperties ? (
                        <div className="text-red-500 text-xs mt-1 ">
                          {errors.details.availableProperties}
                        </div>
                      ) : null}
              ...
              {activeSection === "about" && (
                <div>
                  ...
                  <div>
                    ...
                    />
                    <div className="h-1">
                      {errors.about?.content && touched.about?.content ? (
                        <div className="text-red-500 text-xs mt-1 ">
...
export default EditDetailedCity;
