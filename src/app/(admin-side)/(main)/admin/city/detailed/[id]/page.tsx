...
"use client"
import { detailedViewCityApi, editDetailedCityApi, listCityApi } from "@/src/lib/api_service_client/admin_service/city_handler";
import { cityResType, detailedCityResType, detailedCityType } from "@/src/type/components_type/all_admin_type";
...
const EditDetailedCity=({params}:{ params: Promise<{ id: string }> })=>{
    ...
    const filteredCityList = allCity.filter(city => city.id !== allData?.cityId);
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        >
          ...
          <option value={allData?.cityId} >{allData?.city?.cityName}</option>
