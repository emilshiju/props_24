"use client"
import { addCityApi, listCityApi } from '@/src/lib/api_service_client/admin_service/city_handler';
...
const AddFeaturedProperties=()=>{
  ...
  const initialValues={name:"",price:"",room:"",city:"",bathroom:"",sm:""}
  ...
  const handleSubmit=async(values_data:PropertyType,formikHelpers:FormikHelpers<PropertyType>)=>{
    ...
    setPropertieImage(true)
      ...
      const handleUpload=async()=>{
        ...
        return (
          ...
          <h2 className="text-[24px] font-semibold text-center text-gray-800 mb-6">Add Propertie Details</h2>
    ...
    <option key={idx} value={city.id}>
      ...
      >
        ...
        {showPropertyImage&&<div className="flex items-center justify-center min-h-screen">
