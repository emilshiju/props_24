      ...
      <div className="max-w-md w-full p-8 bg-white rounded-lg shadow-lg text-center">
        ...
        {!allData && (
          <p className="text-gray-600 mb-6">
            Your account is currently under verification. Please wait for admin
            approval.
          </p>
        )}
        {!allData && (
          <p className="text-gray-500 mb-4">
            Once verified, you will be notified via email and can proceed to use
            all features of the platform.
          </p>
        )}
        {!allData ? (
          <div className="inline-block px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200">
            waiting
          </div>
        ) : (
          <div className="inline-block px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200">
