...
const [results, setResults] = useState<Results>({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {activeTab=='agents'&&     <div className="flex flex-wrap justify-center sm:justify-start gap-4">
              {/* <div className="flex justify-center" > */}
              {/* <div className="sm:grid grid-cols-1  sm:grid-cols-1 md:grid-cols-3 gap-4"> */}
              {results.agents&&results.agents.map((data:any,index)=>(
...
{activeTab=='agencies'&&     <div className="flex flex-wrap justify-center sm:justify-start gap-4">
              {/* <div className="flex justify-center" > */}
              {/* <div className="sm:grid grid-cols-1  sm:grid-cols-1 md:grid-cols-3 gap-4"> */}
              {results.agencies&&results.agencies.map((data:any,index)=>(
