  ...
  Since 2020, we&apos;ve been helping clients find the best real estate agents across Italy.
                  ...
                  <div className="col-span-1">
                    ...
                    <ul className="space-y-3">
                      <li>
                        <div className="text-sm text-gray-500 hover:text-primary-light">
                          Our Story
                        </div>
                      </li>
                      <li>
                  ...
                  <div className="col-span-1">
                    ...
                    <ul className="space-y-3">
                      <li>
                        <Link href="/agent" className="text-sm text-gray-500 hover:text-primary-light">
                          Find Agents
                        </Link>
                      </li>
                      <li>
                ...
                <div className="border-t border-gray-200 pt-8">
                  <div className="flex flex-col md:flex-row md:justify-between items-center">
                    ...
                    <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6 text-sm text-center md:text-right">
                      <div className="text-gray-500 hover:text-primary-light">
                        Terms of Service
                      </div>
                      <div className="text-gray-500 hover:text-primary-light">
                        Privacy Policy
